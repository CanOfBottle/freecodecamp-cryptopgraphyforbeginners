...
print("""
Hello! You can use this program to:
- Analyze and hash files to detect tampering
- Encypt and Decrypt messsages with AES and RSA
...
print("You are exiting the program. I hope you have learned something from these cryptography tools!")
